...
read_mem {
  ...
  D:/BarIlan/DDP/exercises/RiscV_pipe/riscv_pipe/riscv_pipe/riscv_pipe.srcs/sources_1/new/data_init_tb.mem
}
read_verilog -library xil_defaultlib {
  D:/BarIlan/DDP/exercises/RiscV_pipe/riscv_pipe/riscv_pipe/riscv_pipe.srcs/sources_1/new/defines.v
  D:/BarIlan/DDP/exercises/RiscV_pipe/riscv_pipe/riscv_pipe/riscv_pipe.srcs/sources_1/new/data_ram.v
  D:/BarIlan/DDP/exercises/RiscV_pipe/riscv_pipe/riscv_pipe/riscv_pipe.srcs/sources_1/new/mem_stage.v
}
...
synth_design -top mem_stage -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef mem_stage.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file mem_stage_utilization_synth.rpt -pb mem_stage_utilization_synth.pb"
