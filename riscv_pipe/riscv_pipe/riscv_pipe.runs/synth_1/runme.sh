...
HD_PWD='D:/BarIlan/DDP/exercises/RiscV_pipe/riscv_pipe/riscv_pipe/riscv_pipe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log execution.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source execution.tcl
